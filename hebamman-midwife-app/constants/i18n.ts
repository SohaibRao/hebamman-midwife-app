...
export const de = {
  ...
  // Phone Bookings (Telefon-Termine / G Slots)
  phoneBookings: {
    title: 'Telefon-Termine',
    subtitle: 'Telefonberatungen Ihrer Patientinnen',
    upcoming: 'Bevorstehende Telefon-Termine',
    past: 'Vergangene Telefon-Termine',
    cancelled: 'Abgesagte Telefon-Termine',
    noBookings: 'Keine Telefon-Termine vorhanden',
    noUpcoming: 'Keine bevorstehenden Telefon-Termine',
    noPast: 'Keine vergangenen Telefon-Termine',
    noCancelled: 'Keine abgesagten Telefon-Termine',
  ...
  // Private Service Bookings (Privatleistungen)
  privateServices: {
    title: 'Privatleistungen',
    subtitle: 'Privatleistungs-Buchungen Ihrer Patientinnen',
    upcoming: 'Bevorstehende Buchungen',
    past: 'Vergangene Buchungen',
    cancelled: 'Abgesagte Buchungen',
    noBookings: 'Keine Privatleistungs-Buchungen vorhanden',
    noUpcoming: 'Keine bevorstehenden Buchungen',
    noPast: 'Keine vergangenen Buchungen',
    noCancelled: 'Keine abgesagten Buchungen',
    ...
    status: 'Status',
    contact: 'Kontakt',
    bookingTypeSingle: 'Einzeltermin',
    bookingTypeCourse: 'Kursreihe',
    modeIndividual: 'Einzeln',
    modeGroup: 'Gruppe',
    typeInPersona: 'Vor Ort',
